...
const possibleArgs = {
    ...
    '--folder <full path>'          : 'Required: Base folder of application - Default: .',
    ...
    '--workdir <directory>'         : 'Optional: Workdir where app will be added and run from - default: /opt/app-root/src',
